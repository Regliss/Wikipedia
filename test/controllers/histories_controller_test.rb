...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { auteur: @history.auteur, content: @history.content } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { auteur: @history.auteur, content: @history.content } }
